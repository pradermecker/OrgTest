#+TITLE: TODO CICD
#+LaTeX_CLASS: pi3r-org-paragraph
...
#+LaTeX_HEADER: \addtokomafont{section}{\large}
...
#+LaTeX_HEADER: \renewcommand{\theparagraph}{\small(\arabic{paragraph})}
#+LaTeX_HEADER: \renewcommand\labelenumi{\textbullet}
#+LaTeX_HEADER: \renewcommand{\labelitemi}{$-$}
#+OPTIONS: H:2 num:4 title:t tags:nil tasks:todo todo:nil e:t d:nil p:nil \n:nil f:t *:t
