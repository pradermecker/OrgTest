...
#+LaTeX_CLASS_OPTIONS: [numbers=endperiod,colorlinks=true,urlcolor=blue,headinclude=false,headings=normal]
...
#+LaTeX_HEADER: \renewcommand\maketitle{\begin{center} {\large\bfseries\@title\par\vspace{0.3em}} {\small\@date} \end{center}}
